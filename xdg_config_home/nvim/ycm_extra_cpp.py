...
import ycm_extra_common as common
...
def GetCompilationInfoForFile(filename):
    ...
    if common.is_header_file(filename):
        basename = os.path.splitext(filename)[0]
        for extension in common.SOURCE_EXTENSIONS:
...
def FlagsForFile(filename, **kwargs):
    if database:
        ...
        relative_to = common.HERE
        final_flags = MakeRelativePathsInFlagsAbsolute(common.CPP_FLAGS, relative_to)
