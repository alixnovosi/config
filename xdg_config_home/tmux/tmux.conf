...
#########################################  COLOURS  ###############################################
###################################################################################################
# This attempts to emulate airline's (https://github.com/bling/vim-airline) solarized dark colours.
# We use 16 colours because tmux doesn't seem to like 256.
...
# Panel right side: date, dow, time.
set -g status-right ' #(date +"%Y %b %d|%a|%H:%M") '

# Panel left side: session title, hostname.
