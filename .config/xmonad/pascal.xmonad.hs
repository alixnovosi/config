...
myBitmapsPath = xmonad_home ++ "/dzen/bitmaps/"

-- Dzen handles window info and the right is conky being cool.
myDzenStatus :: String
myDzenStatus = "dzen2 -x '0' -w '700' -ta 'l'" ++ myDzenStyle

myDzenConky :: String
myDzenConky  = "conky -c ~/.conky_dzen | dzen2 -x '700' -w '800' -ta 'r'" ++ myDzenStyle
...
main = do
    ...
    xmonad $ withUrgencyHook NoUrgencyHook defaultConfig
        ...
        , ((myModMask, xK_e),                    spawn "~/bin/toggleOneko")
        , ((myModMask, xK_w),                    spawn  "x-www-browser")
